...
from agent.opt_Worker import Opt_Workers
...
class Opt_Trainer:
    def __init__(self,parameter:Parameters = None,log_dir = None ) -> None:
        ...
        self.encoder_type = envencoder.OptEnvencoder
        ...
        self.training_agent = Opt_Workers(parameter=self.parameter, env_name=self.parameter.env_name,
        ...
        ## Stationary
        self.s_test_agent = Opt_Workers(parameter=self.parameter, env_name=self.parameter.env_name,
        ...
        self.ns_test_agent = Opt_Workers(parameter=self.parameter, env_name=self.parameter.env_name,
